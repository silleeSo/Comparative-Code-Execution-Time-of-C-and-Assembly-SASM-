...
generateFixedVector:
    ...
    call    malloc           ; Allocate memory for the array - I hab no idea pa how to implement this
...
random_double:
    ...
    call    srand            ; Seed random number generator - I hab no idea pa how to implement this
    call    rand             ; Generate random number - I hab no idea pa how to implement this
    cvtsi2sd xmm0, eax       ; Convert random number to double in xmm0
    divsd   xmm0, [rel RAND_MAX_DOUBLE]  ; Divide by RAND_MAX_DOUBLE (max random number)
    ret
